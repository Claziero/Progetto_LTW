...
async function loadMainListing() {
    ...
    var query = "SELECT Titolo, Tipo, DataOra, PostiDisponibili, Descrizione, ID, Disponibile, Immagine\
...
async function getImagesList() {
    var query = 'SELECT DISTINCT Immagine FROM Evento;';
