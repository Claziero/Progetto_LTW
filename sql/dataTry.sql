...
INSERT INTO Event VALUES
    -- Eventi passati
    (1, 'promoter@user.com', 'Torneo di scacchi', 'Torneo', 'Roma, IT', '2023-01-19 10:30', 
        50, 'Evento torneo di scacchi. 4 persone', False, True, 'chess.png'),
    (2, 'promoter@user.com', 'Duello di Wrestling', 'Singolo', 'Napoli, IT', '2023-02-20 11:30', 
        50, 'Evento duello di Wrestling. 2 persone', False, True, 'wrestling.png'),
    (3, 'promoter@user.com', 'Torneo di giochi da tavolo', 'Torneo', 'Milano, IT', '2023-03-22 12:00',
        20, 'Evento torneo di giochi da tavolo. 4-8 persone', False, True, 'boardgame.png'),
    
    -- Eventi correnti
    (4, 'promoter@user.com', 'Torneo di braccio di ferro', 'Torneo', 'Roma, IT', '2023-05-04 10:30', 
        40, 'Evento torneo di braccio di ferro. 2 persone', True, False, 'armwrestling.png'),
    (5, 'promoter@user.com', 'Torneo di tennis', 'Torneo', 'Verona, IT', '2023-05-15 19:30', 
        30, 'Evento torneo di tennis. 2 persone', True, False, 'tennis.png'),
    (6, 'promoter@user.com', 'Partita di pallavolo', 'Singolo', 'Firenze, IT', '2023-05-29 21:00', 
        90, 'Evento partita di pallavolo. 10 persone', True, False, 'volleyball.png'),
    (7, 'promoter@user.com', 'Duello di scherma', 'Singolo', 'Napoli, IT', '2023-05-31 11:30', 
        30, 'Evento duello di scherma. 2 persone', True, False, 'scherma.png'),
    (8, 'promoter@user.com', 'Gara di motocross', 'Singolo', 'Milano, IT', '2023-06-05 12:00', 
        60, 'Evento gara di motocross. 8-12 persone', True, False, 'motocross.png'),
    (9, 'promoter@user.com', 'Gara di autoscontro', 'Singolo', 'Bari, IT', '2023-06-22 12:00', 
        90, 'Evento gara di autoscontro. 8-12 persone', True, False, 'demolitionderby.png'),

    -- Eventi futuri
    (10, 'promoter@user.com', 'Torneo di D&D', 'Torneo', 'Bari, IT', '2023-08-24 12:00', 
        10, 'Evento torneo di Dungeons & Dragons. 6-8 persone', True, False, 'boardgame.png'),
    (11, 'promoter@user.com', 'Esibizione di canto', 'Singolo', 'Palermo, IT', '2023-09-27 12:00', 
        50, 'Evento esibizione di canto. 1 persona', True, False, 'sing.png'),
    (12, 'promoter@user.com', 'Torneo di ballo', 'Torneo', 'Verona, IT', '2023-11-30 12:00', 
